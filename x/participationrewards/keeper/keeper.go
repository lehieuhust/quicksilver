...
type Keeper struct {
	...
	prSubmodules     map[string]Submodule
}
...
func LoadSubmodules() map[string]Submodule {
	out := make(map[string]Submodule, 0)
	out["osmosis"] = &OsmosisModule{}
	out["liquid"] = &LiquidTokensModule{}
	return out
}
